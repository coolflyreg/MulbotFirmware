...
namespace Language_zh_CN {
  ...
  PROGMEM Language_Str MSG_MEDIA_ABORTING                  = _UxGT("终止中...");
  PROGMEM Language_Str MSG_MEDIA_RELEASED                  = _UxGT("存储卡已释放");
  PROGMEM Language_Str MSG_MEDIA_WAITING                   = _UxGT("等待存储卡");
  PROGMEM Language_Str MSG_MEDIA_READ_ERROR                = _UxGT("存储卡读取失败");
  PROGMEM Language_Str MSG_MEDIA_USB_REMOVED               = _UxGT("USB设备已移除");
  PROGMEM Language_Str MSG_MEDIA_USB_FAILED                = _UxGT("USB启动失败");
  PROGMEM Language_Str MSG_LCD_SOFT_ENDSTOPS               = _UxGT("软限位器");
  ...
  PROGMEM Language_Str MSG_LASER_OFF                       = _UxGT("关闭激光");
  PROGMEM Language_Str MSG_LASER_ON                        = _UxGT("开启激光");
  PROGMEM Language_Str MSG_LASER_POWER                     = _UxGT("激光电源");
  PROGMEM Language_Str MSG_SPINDLE_MENU                    = _UxGT("主轴控制");
  PROGMEM Language_Str MSG_SPINDLE_OFF                     = _UxGT("关闭主轴");
  PROGMEM Language_Str MSG_SPINDLE_ON                      = _UxGT("打开主轴");
  ...
  PROGMEM Language_Str MSG_PROBING_MESH                    = _UxGT("正在探测点");
  PROGMEM Language_Str MSG_MESH_X                          = _UxGT("X索引");
  PROGMEM Language_Str MSG_MESH_Y                          = _UxGT("Y索引");
  PROGMEM Language_Str MSG_MESH_EDIT_Z                     = _UxGT("Z值");
  PROGMEM Language_Str MSG_M48_TEST                        = _UxGT("M48探针测试");
  ...
  PROGMEM Language_Str MSG_OFFSETS_MENU                    = _UxGT("工具偏移");
  PROGMEM Language_Str MSG_IDEX_MODE_AUTOPARK              = _UxGT("自动停泊");
  PROGMEM Language_Str MSG_IDEX_MODE_DUPLICATE             = _UxGT("复制");
  PROGMEM Language_Str MSG_IDEX_MODE_MIRRORED_COPY         = _UxGT("镜像拷贝");
  PROGMEM Language_Str MSG_IDEX_MODE_FULL_CTRL             = _UxGT("全面控制"); // Full Control
  PROGMEM Language_Str MSG_HOTEND_OFFSET_X                 = _UxGT("第2个打印头 X");
  PROGMEM Language_Str MSG_HOTEND_OFFSET_Y                 = _UxGT("第2个打印头 Y");
  PROGMEM Language_Str MSG_HOTEND_OFFSET_Z                 = _UxGT("第2个打印头 Z");
  ...
  PROGMEM Language_Str MSG_PID_AUTOTUNE                    = _UxGT("PID 自动校准");
  PROGMEM Language_Str MSG_PID_AUTOTUNE_E                  = _UxGT("PID 自动校准 *");
  PROGMEM Language_Str MSG_JUNCTION_DEVIATION              = _UxGT("Junction Dev");
  PROGMEM Language_Str MSG_ADVANCE_K                       = _UxGT("高级 K");
  PROGMEM Language_Str MSG_ADVANCE_K_E                     = _UxGT("高级 K *");
  PROGMEM Language_Str MSG_MEDIA_UPDATE                    = _UxGT("存储卡更新");
  PROGMEM Language_Str MSG_RESET_PRINTER                   = _UxGT("重置打印机");
  PROGMEM Language_Str MSG_START_PRINT                     = _UxGT("开始打印");
  PROGMEM Language_Str MSG_BUTTON_NEXT                     = _UxGT("下一步");
  ...
  PROGMEM Language_Str MSG_BUTTON_RESET                    = _UxGT("重置");
  PROGMEM Language_Str MSG_BUTTON_CANCEL                   = _UxGT("取消");
  PROGMEM Language_Str MSG_BUTTON_DONE                     = _UxGT("完成");
  PROGMEM Language_Str MSG_BUTTON_BACK                     = _UxGT("回退");
  PROGMEM Language_Str MSG_BUTTON_PROCEED                  = _UxGT("继续");
  PROGMEM Language_Str MSG_PRINTING_OBJECT                 = _UxGT("打印中目标");
  PROGMEM Language_Str MSG_CANCEL_OBJECT                   = _UxGT("取消目标");
  PROGMEM Language_Str MSG_CANCEL_OBJECT_N                 = _UxGT("取消目标 =");
  PROGMEM Language_Str MSG_OUTAGE_RECOVERY                 = _UxGT("Outage Recovery");
  PROGMEM Language_Str MSG_PRINTING                        = _UxGT("打印中...");
  PROGMEM Language_Str MSG_FILAMENT_SWAP_LENGTH            = _UxGT("切换长度");
  PROGMEM Language_Str MSG_FILAMENT_PURGE_LENGTH           = _UxGT("擦拭长度"); // Purge Length
  PROGMEM Language_Str MSG_TOOL_CHANGE                     = _UxGT("工具切换");
  PROGMEM Language_Str MSG_TOOL_CHANGE_ZLIFT               = _UxGT("Z提升");
  PROGMEM Language_Str MSG_SINGLENOZZLE_PRIME_SPD          = _UxGT("主要速度");
  PROGMEM Language_Str MSG_SINGLENOZZLE_RETRACT_SPD        = _UxGT("回抽速度");
  PROGMEM Language_Str MSG_NOZZLE_STANDBY                  = _UxGT("打印头等待");
  PROGMEM Language_Str MSG_RELEASE_MEDIA                   = _UxGT("释放存储卡");
  PROGMEM Language_Str MSG_BLTOUCH_SW_MODE                 = _UxGT("命令: SW-Mode");
  PROGMEM Language_Str MSG_BLTOUCH_5V_MODE                 = _UxGT("命令: 5V-Mode");
  PROGMEM Language_Str MSG_BLTOUCH_OD_MODE                 = _UxGT("命令: OD-Mode");
  PROGMEM Language_Str MSG_BLTOUCH_MODE_STORE              = _UxGT("命令: Mode-Store");
  PROGMEM Language_Str MSG_BLTOUCH_MODE_STORE_5V           = _UxGT("设置 BLTouch 到 5V");
  PROGMEM Language_Str MSG_BLTOUCH_MODE_STORE_OD           = _UxGT("设置 BLTouch 到 OD");
  ...
  PROGMEM Language_Str MSG_TOUCHMI_ZTEST                   = _UxGT("Z 偏移测试");
  PROGMEM Language_Str MSG_TOUCHMI_SAVE                    = _UxGT("保存");
  PROGMEM Language_Str MSG_MANUAL_DEPLOY_TOUCHMI           = _UxGT("部署 TouchMI");
  PROGMEM Language_Str MSG_MANUAL_DEPLOY                   = _UxGT("部署 Z-探针");
  PROGMEM Language_Str MSG_MANUAL_STOW                     = _UxGT("收起 Z-探针");
  PROGMEM Language_Str MSG_BABYSTEP_TOTAL                  = _UxGT("总共");
  ...
  PROGMEM Language_Str MSG_CHAMBER_HEATING                 = _UxGT("Chamber 加热中...");
  PROGMEM Language_Str MSG_CHAMBER_COOLING                 = _UxGT("Chamber 冷却中...");
  PROGMEM Language_Str MSG_DELTA_Z_OFFSET_CALIBRATE        = _UxGT("探针 Z偏移");
  ...
  PROGMEM Language_Str MSG_FILAMENT_CHANGE_HEADER          = _UxGT("丝料 替换");
  PROGMEM Language_Str MSG_RUNOUT_SENSOR                   = _UxGT("断料传感器");
  PROGMEM Language_Str MSG_RUNOUT_DISTANCE_MM              = _UxGT("断料检测距离 mm");
  PROGMEM Language_Str MSG_MMU2_CHOOSE_FILAMENT_HEADER     = _UxGT("选择 丝料");
  PROGMEM Language_Str MSG_MMU2_MENU                       = _UxGT("MMU");
  PROGMEM Language_Str MSG_MMU2_WRONG_FIRMWARE             = _UxGT("更新 MMU 固件！");
  PROGMEM Language_Str MSG_MMU2_NOT_RESPONDING             = _UxGT("MMU 需要关注。");
  PROGMEM Language_Str MSG_MMU2_RESUME                     = _UxGT("恢复打印");
  PROGMEM Language_Str MSG_MMU2_RESUMING                   = _UxGT("恢复中...");
  PROGMEM Language_Str MSG_MMU2_LOAD_FILAMENT              = _UxGT("装载丝料");
  PROGMEM Language_Str MSG_MMU2_LOAD_ALL                   = _UxGT("装载全部");
  PROGMEM Language_Str MSG_MMU2_LOAD_TO_NOZZLE             = _UxGT("装载到打印头");
  PROGMEM Language_Str MSG_MMU2_EJECT_FILAMENT             = _UxGT("抽出丝料");
  PROGMEM Language_Str MSG_MMU2_EJECT_FILAMENT_N           = _UxGT("抽出丝料 ~");
  PROGMEM Language_Str MSG_MMU2_UNLOAD_FILAMENT            = _UxGT("卸载丝料");
  PROGMEM Language_Str MSG_MMU2_LOADING_FILAMENT           = _UxGT("装料中 %i...");
  PROGMEM Language_Str MSG_MMU2_EJECTING_FILAMENT          = _UxGT("抽料中 ...");
  PROGMEM Language_Str MSG_MMU2_UNLOADING_FILAMENT         = _UxGT("卸料中...");
  PROGMEM Language_Str MSG_MMU2_ALL                        = _UxGT("全部");
  PROGMEM Language_Str MSG_MMU2_FILAMENT_N                 = _UxGT("丝料 ~");
  PROGMEM Language_Str MSG_MMU2_RESET                      = _UxGT("重置 MMU");
  PROGMEM Language_Str MSG_MMU2_RESETTING                  = _UxGT("正在重置 MMU...");
  PROGMEM Language_Str MSG_MMU2_EJECT_RECOVER              = _UxGT("Remove, click");
  PROGMEM Language_Str MSG_MIX_COMPONENT_N                 = _UxGT("组件 =");
  ...
  PROGMEM Language_Str MSG_SERVICE_RESET                   = _UxGT("重置");
