...
// #endif
  ...
  #define CASE_LIGHT_PIN P1_23                  // Override the default pin if needed
...
//#define PHOTO_GCODE
  ...
  #define PHOTO_DELAY_MS   5000//100                            // (ms) Duration to pause before moving back (M240 P)
  #define PHOTO_RETRACT_MM   5//6.5                          // (mm) E retract/recover for the photo move (M240 R S)
