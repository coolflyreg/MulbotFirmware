...
#define STRING_CONFIG_H_AUTHOR "(coolflyr_reg, MULBOT)" // Who made the changes.
...
#elif MOTHERBOARD == BOARD_RAMPSXB
  #define MIXING_STEPPERS 6        // Number of steppers in your mixing extruder
#else
  #define MIXING_STEPPERS 3        // Number of steppers in your mixing extruder
#endif
...
#if MOTHERBOARD == BOARD_RAMPSXB
  // Mulbot NF full color Hotend
  #define DEFAULT_Kp 24.2
  #define DEFAULT_Ki 1.07
  #define DEFAULT_Kd 137.29
#else
  // Mulbot NF mix color Hotend
  // #define DEFAULT_Kp 36.85
  // #define DEFAULT_Ki 3.81
  // #define DEFAULT_Kd 89.06
  #define DEFAULT_Kp 82.00
  #define DEFAULT_Ki 7.01
  #define DEFAULT_Kd 236.78
#endif
 ...
 */
// #define DEFAULT_AXIS_STEPS_PER_UNIT   { 320, 320, 404, 92.6, 92.6, 92.6 }
#if MOTHERBOARD == BOARD_FLY32
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 320, 320, 404, 400, 400, 400 } // BMG for Extruders
#elif MOTHERBOARD == BOARD_RAMPSXB
...
#else
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 159.6, 153.6, 400, 400, 400, 400 } // Titan for Extruders
#endif
...
#if MOTHERBOARD == BOARD_FLY32
#define INVERT_E2_DIR true//true
#else
#define INVERT_E2_DIR false//true
#endif
